...
//         switch (occasion) {
//             case 'birthday':
//                 setWatermarkText('Happy Birthday!');
//                 break;
//             case 'christmas':
//                 setWatermarkText('Merry Christmas!');
//                 break;
//             case 'wedding':
//                 setWatermarkText('Happy Wedding!');
//                 break;
//             case 'anniversary':
//                 setWatermarkText('Happy Anniversary!');
//                 break;
//             case 'friendship':
//                 setWatermarkText('To My Friend!');
//                 break;
//             case 'postcard':
//                 setWatermarkText('Greetings!');
//                 break;
//             case 'fathers-day':
//                 setWatermarkText('Happy Father\'s Day!');
//                 break;
//             case 'mothers-day':
//                 setWatermarkText('Happy Mother\'s Day!');
//                 break;
//             default:
//                 setWatermarkText('');
//         }
        ...
        try {
            ...
            if (data.imageUrl) {
                ...
                if (data.code === 'INSUFFICIENT_CREDITS') {
                    toast.error('Sorry, no more credits for this model. Use your own uploaded images instead.', {
                        duration: 5000,
                    });
                    setUseAIImage(false); // Switch to uploaded images
                    setImageModel(''); // Clear image model
                } else {
                    setMessage({ title: 'Error', text: data.error || 'Failed to generate image.' });
                }
            }
